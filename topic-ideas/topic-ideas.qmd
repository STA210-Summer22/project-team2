...
-   Describe a research question you're interested in answering using this data. A research question we want to explore is: Can a county's characteristics (racial composition, gender compositation. etc) be used to predict it's cancer deathrate? If so, What model is best for predicating?
...
-   Describe a research question you're interested in answering using this data.
    -   Which features or predictions (locations, reviews, cost, etc.) have the most influence on airbnb reservations?
-   Glimpse of data
-   
-   Use the `glimpse` function to provide an overview of the dataset
